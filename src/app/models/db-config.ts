...
export const CREATE_TABLES: string[]=[
    ...
    'CREATE TABLE IF NOT EXISTS EMERGENCY(ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME TEXT NOT NULL, PHONE_NUMBER TEXT NOT NULL, ALTERNATE_PHONE_NUMBER TEXT NOT NULL, AGE INTEGER NOT NULL, ADDRESS TEXT NOT NULL, LOCATION TEXT NOT NULL, REPORT TEXT);',
